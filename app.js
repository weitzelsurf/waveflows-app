...
// SVG Icons
// ─────────────────────────────────────────────────────────────────────────────
const Heart = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" }));
const MapPin = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" }), React.createElement('circle', { cx: "12", cy: "10", r: "3" }));
const TrendingUp = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('polyline', { points: "23 6 13.5 15.5 8.5 10.5 1 18" }), React.createElement('polyline', { points: "17 6 23 6 23 12" }));
const TrendingDown = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('polyline', { points: "23 18 13.5 8.5 8.5 13.5 1 6" }), React.createElement('polyline', { points: "17 18 23 18 23 12" }));
const Minus = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('line', { x1: "5", y1: "12", x2: "19", y2: "12" }));
const Bell = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" }), React.createElement('path', { d: "M13.73 21a2 2 0 0 1-3.46 0" }));
const Search = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('circle', { cx: "11", cy: "11", r: "8" }), React.createElement('path', { d: "m21 21-4.35-4.35" }));
const Star = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "currentColor", ...props }, React.createElement('polygon', { points: "12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26" }));
const Activity = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('polyline', { points: "22,12 18,12 15,21 9,3 6,12 2,12" }));
const Download = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }), React.createElement('polyline', { points: "7,10 12,15 17,10" }), React.createElement('line', { x1: "12", y1: "15", x2: "12", y2: "3" }));
const Wifi = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M5 12.55a11 11 0 0 1 14.08 0" }), React.createElement('path', { d: "M1.42 9a16 16 0 0 1 21.16 0" }), React.createElement('path', { d: "M8.53 16.11a6 6 0 0 1 6.95 0" }), React.createElement('circle', { cx: "12", cy: "20", r: "1" }));
const WifiOff = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('line', { x1: "2", y1: "2", x2: "22", y2: "22" }), React.createElement('path', { d: "M8.5 16.5a5 5 0 0 1 7 0" }), React.createElement('path', { d: "M2 8.82a15 15 0 0 1 4.17-2.65" }), React.createElement('path', { d: "M10.66 5c4.01-.36 8.14.9 11.34 3.76" }), React.createElement('path', { d: "M16.85 11.25a10 10 0 0 1 2.22 1.68" }), React.createElement('path', { d: "M5 13a10 10 0 0 1 5.24-2.76" }), React.createElement('circle', { cx: "12", cy: "20", r: "1" }));
const RefreshCw = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('polyline', { points: "23 4 23 10 17 10" }), React.createElement('polyline', { points: "1 20 1 14 7 14" }), React.createElement('path', { d: "M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" }));
const MessageSquare = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('path', { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }));
const Send = ({ className, ...props }) => React.createElement('svg', { className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, ...props }, React.createElement('line', { x1: "22", y1: "2", x2: "11", y2: "13" }), React.createElement('polygon', { points: "22 2 15 22 11 13 2 9 22 2" }));

// ─────────────────────────────────────────────────────────────────────────────
// Utility: human-readable "X ago" from a Firestore timestamp
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// ReportsList — live-updating list of community reports for a spot
// ─────────────────────────────────────────────────────────────────────────────
const ReportsList = ({ spotId }) => {
  ...
  const conditionBadge = (condition) => {
    switch (condition) {
      case 'excellent': return { text: '🔥 Epic',     color: 'text-green-700 bg-green-100' };
      case 'good':      return { text: '👍 Good',     color: 'text-blue-700 bg-blue-100' };
      case 'marginal':  return { text: '😐 Marginal', color: 'text-yellow-700 bg-yellow-100' };
      case 'poor':      return { text: '👎 Poor',     color: 'text-red-700 bg-red-100' };
      default:          return { text: condition,     color: 'text-gray-700 bg-gray-100' };
    }
  };

  if (loading) return React.createElement('p', { className: "text-sm text-gray-400 text-center py-3" }, 'Loading reports...');
  if (reports.length === 0) return React.createElement('p', { className: "text-sm text-gray-400 italic text-center py-3" }, 'No reports yet — be the first to share conditions!');

  return React.createElement('div', { className: "space-y-3" },
    reports.map(report => {
      const badge = conditionBadge(report.condition);
      return React.createElement('div', { key: report.id, className: "bg-white rounded-lg p-3 border border-gray-100 shadow-sm" },
        ...
        report.flowAtReport
          ? React.createElement('p', { className: "text-xs text-gray-400 mt-1" },
              `Flow at time of report: ${Number(report.flowAtReport).toLocaleString()} ${report.flowUnit || 'cfs'}`)
          : null
      );
    })
  );
...
// ─────────────────────────────────────────────────────────────────────────────
// ReportForm — submit a field report to Firebase
// ─────────────────────────────────────────────────────────────────────────────
const ReportForm = ({ spotId, spotName, currentFlow, flowUnit }) => {
  ...
  return React.createElement('div', { className: "bg-gray-50 rounded-lg p-4 border border-gray-200" },
    React.createElement('h4', { className: "font-semibold text-gray-900 mb-3 flex items-center gap-2" },
      React.createElement(MessageSquare, { className: "h-4 w-4 text-blue-600" }), 'Submit Field Report'),
        ...
        conditionOptions.map(opt =>
          React.createElement('button', {
            ...
            className: `px-3 py-1 rounded-full text-xs font-medium border transition-all ${
              condition === opt.value ? opt.color + ' border-2' : 'bg-white text-gray-500 border-gray-200 hover:border-gray-300'
            }`
          }, opt.label)
        )
      )
    ...
    React.createElement('textarea', {
      ...
      placeholder: "Describe conditions — wave shape, size, crowds, hazards, anything helpful for other surfers...",
      rows: 3,
      maxLength: 280,
    ...
    React.createElement('div', { className: "flex justify-between mb-3" },
      ...
      typeof currentFlow === 'number'
        ? React.createElement('span', { className: "text-xs text-gray-400" }, `Current flow: ${currentFlow.toLocaleString()} ${flowUnit}`)
        : null
    ),
    ...
    React.createElement('div', { className: "flex gap-2" },
      React.createElement('button', {
        ...
        className: "flex-1 py-2 px-3 text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors"
      }, 'Cancel'),
      React.createElement('button', {
...
const WaveFlowsPWA = () => {
  ...
  // ─── River Spots (all your updated gauge IDs preserved) ───────────────────
  const riverSpots = [
    ...
    { id: 'daves-wave', name: "Dave's Wave", river: 'South Platte River', location: 'Littleton, CO', gaugeId: '07099970', currentFlow: 420, optimalRange: [250, 650], unit: 'cfs', trend: 'stable', status: 'good', lastUpdated: '—', forecast: [420, 410, 405, 400, 395], description: 'Named after local river surfer Dave', difficulty: 'Intermediate-Advanced' },
    ...
    { id: 'charlies-hole', name: "Charlie's Hole", river: 'Yampa River', location: 'Steamboat Springs, CO', gaugeId: '09239500', currentFlow: 380, optimalRange: [250, 700], unit: 'cfs', trend: 'stable', status: 'good', lastUpdated: '—', forecast: [380, 375, 370, 365, 360], description: 'Classic hole feature in Steamboat', difficulty: 'Advanced' },
    ...
    { id: 'farmington-river-wave', name: 'Farmington River Wave', river: 'Animas River', location: 'Farmington, NM', gaugeId: '09365000', currentFlow: 480, optimalRange: [300, 800], unit: 'cfs', trend: 'stable', status: 'excellent', lastUpdated: '—', forecast: [480, 475, 470, 465, 460], description: 'Brand new adjustable wave feature at Gateway Park - first in Four Corners region!', difficulty: 'All Levels' },

    // Out of State
    { id: 'skookumchuck-narrows', name: 'Skookumchuck Narrows', river: 'Sechelt Rapids', location: 'Egmont, BC', gaugeId: null, currentFlow: 'Tidal', optimalRange: ['Incoming tide', 'High tide'], unit: 'tidal', trend: 'tidal', status: 'excellent', lastUpdated: 'Tidal data N/A', forecast: ['High', 'High', 'Med', 'Low', 'Med'], description: 'World-class tidal bore surfing', difficulty: 'Expert' },
  ...
  // ─── USGS Live Gauge Fetching ──────────────────────────────────────────────
  const fetchGaugeData = useCallback(async () => {
    if (!navigator.onLine) return;
    const uniqueGaugeIds = [...new Set(riverSpots.filter(s => s.gaugeId).map(s => s.gaugeId))];
    setIsFetching(true);
    setFetchError(false);
    try {
      ...
      data.value.timeSeries.forEach(series => {
        ...
        const lastUpdatedStr = minutesAgo <= 1 ? 'just now' : minutesAgo < 60 ? `${minutesAgo} min ago` : `${Math.round(minutesAgo / 60)} hr ago`;
        if (!isNaN(latest)) updates[siteCode] = { flow: Math.round(latest), trend, lastUpdated: lastUpdatedStr };
      });
  ...
  const enrichSpot = (spot) => {
    ...
    return { ...spot, currentFlow: live.flow, trend: live.trend, lastUpdated: live.lastUpdated, status };
  };
  ...
  const requestNotificationPermission = async () => {
    if ('Notification' in window) {
      ...
      if (permission === 'granted') {
        ...
        new Notification('WaveFlows Notifications Enabled!', { body: "You'll get alerts when your favorite spots hit optimal conditions.", icon: '/icon-192x192.png' });
      }
    }
  };

  useEffect(() => {
    try { const s = localStorage.getItem('waveflows-favorites'); if (s) setFavorites(JSON.parse(s)); } catch (e) {}
  }, []);
  useEffect(() => {
  ...
  const toggleFavorite = (spotId) => setFavorites(prev => prev.includes(spotId) ? prev.filter(id => id !== spotId) : [...prev, spotId]);
  ...
  const lastFetchDisplay = lastFetchTime ? lastFetchTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : null;
        ...
        React.createElement('div', { className: "flex items-center justify-between mb-4" },
          ...
          React.createElement('div', { className: "flex items-center space-x-2" },
            ...
            installPrompt && !isInstalled
              ? React.createElement('button', { onClick: handleInstallClick, className: "p-2 rounded-lg bg-blue-600 hover:bg-blue-700 transition-colors", title: "Install WaveFlows" },
        ...
        ? React.createElement('div', { className: "mb-6" },
            ...
            React.createElement('div', { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-3" },
              favoriteSpots.map(spot => React.createElement(SpotCard, {
                key: spot.id, spot, isFavorite: true, onToggleFavorite: toggleFavorite,
                onSelect: setSelectedSpot, getStatusColor, getTrendIcon,
      ...
      React.createElement('div', { className: "mb-6" },
        ...
        React.createElement('div', { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-3" },
          otherSpots.map(spot => React.createElement(SpotCard, {
            key: spot.id, spot, isFavorite: false, onToggleFavorite: toggleFavorite,
            onSelect: setSelectedSpot, getStatusColor, getTrendIcon,
            isLive: !!(spot.gaugeId && liveFlows[spot.gaugeId])
          }))
        )
  ...
  return React.createElement('div', { className: "bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow cursor-pointer" },
    React.createElement('div', { className: "flex justify-between items-start mb-3" },
      React.createElement('div', { className: "flex-1", onClick: () => onSelect(spot) },
        ...
        React.createElement('p', { className: "text-xs text-gray-500 flex items-center mt-1" }, React.createElement(MapPin, { className: "h-3 w-3 mr-1" }), spot.location)
      ),
      React.createElement('button', { onClick: (e) => { e.stopPropagation(); onToggleFavorite(spot.id); }, className: "p-1" },
    ...
    React.createElement('div', { onClick: () => onSelect(spot) },
      React.createElement('div', { className: "flex items-center justify-between mb-2" },
        React.createElement('span', { className: `px-2 py-1 rounded-full text-xs font-medium ${statusColor}` }, spot.status.charAt(0).toUpperCase() + spot.status.slice(1)),
        React.createElement('div', { className: "flex items-center space-x-1" }, getTrendIcon(spot.trend), React.createElement('span', { className: "text-xs text-gray-500" }, spot.trend))
      ),
      React.createElement('div', { className: "space-y-2" },
        React.createElement('div', { className: "flex justify-between items-center" },
          React.createElement('span', { className: "text-sm text-gray-600" }, 'Current Flow:'),
          React.createElement('span', { className: "font-semibold" }, spot.unit === 'tidal' ? spot.currentFlow : `${spot.currentFlow.toLocaleString()} ${spot.unit}`)
        ),
        React.createElement('div', { className: "flex justify-between items-center" },
          React.createElement('span', { className: "text-sm text-gray-600" }, 'Optimal Range:'),
          React.createElement('span', { className: "text-sm" }, spot.unit === 'tidal' ? spot.optimalRange.join(' - ') : `${spot.optimalRange[0].toLocaleString()}–${spot.optimalRange[1].toLocaleString()} ${spot.unit}`)
        ),
        spot.unit !== 'tidal'
          ...
          : null,
        React.createElement('p', { className: "text-xs text-gray-400" }, isLive ? `USGS • ${spot.lastUpdated}` : `Cached • ${spot.lastUpdated}`)
      )
    )
  );
};
...
// ─────────────────────────────────────────────────────────────────────────────
// SpotModal — with community reports + submit form
// ─────────────────────────────────────────────────────────────────────────────
      ...
      React.createElement('div', { className: "p-6" },
        ...
        React.createElement('div', { className: "flex justify-between items-start mb-4" },
          React.createElement('div', null,
            ...
            React.createElement('p', { className: "text-sm text-gray-500 flex items-center mt-1" }, React.createElement(MapPin, { className: "h-4 w-4 mr-1" }), spot.location)
          ),
          React.createElement('div', { className: "flex space-x-2" },
            React.createElement('button', { onClick: () => onToggleFavorite(spot.id), className: "p-2 hover:bg-gray-100 rounded-lg" },
        ...
        React.createElement('div', { className: "bg-gray-50 rounded-lg p-4 mb-5" },
          React.createElement('div', { className: "grid grid-cols-2 gap-4" },
            React.createElement('div', null,
              React.createElement('div', { className: "flex items-center justify-between mb-2" },
                React.createElement('span', { className: `px-3 py-1 rounded-full text-sm font-medium ${statusColor}` }, spot.status.charAt(0).toUpperCase() + spot.status.slice(1)),
                React.createElement('div', { className: "flex items-center space-x-1" }, getTrendIcon(spot.trend), React.createElement('span', { className: "text-sm text-gray-600 capitalize" }, spot.trend))
              ),
              React.createElement('div', { className: "space-y-1" },
                ...
                React.createElement('div', { className: "flex justify-between" },
                  ...
                  React.createElement('span', { className: "text-xs text-gray-500" }, isLive ? `USGS Gauge ${spot.gaugeId}` : 'Static / Cached'))
              )
            ),
            React.createElement('div', null,
              ...
              React.createElement('div', { className: "flex items-end space-x-1 h-12" },
                spot.forecast.map((flow, i) =>
                  React.createElement('div', { key: i, className: "flex-1 bg-blue-200 rounded-t",
                    style: spot.unit === 'tidal' ? { height: '20px' } : { height: `${(flow / Math.max(...spot.forecast)) * 100}%`, minHeight: '4px' }
                  })
                )
              ),
        ...
        // Submit form
        React.createElement(ReportForm, { spotId: spot.id, spotName: spot.name, currentFlow: spot.currentFlow, flowUnit: spot.unit }),
